...
public class SnapshotMode : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        filters.Add(new NeonFilter("NeonTrippy", Color.green, bloomShader, new BaseFilter("", Color.white, neonShader)));
    }
    ...
    private void trippyFilter()
    {
        //private Shader trippyShader = new NeonFilter("Neon", Color.cyan, bloomShader, new BaseFilter("", Color.white, neonShader));
    }
